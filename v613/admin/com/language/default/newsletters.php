...
*/
define('LNG_CreateNewsletterCancelButton', '您确定要取消创建一个新的电子邮件活动吗?');
define('LNG_CreateNewsletterHeading', '邮件活动详细信息');
...
define('LNG_NewsletterName', '邮件活动名称');

define('LNG_NewsletterNameIsNotValid', '邮件活动名称是无效的');
