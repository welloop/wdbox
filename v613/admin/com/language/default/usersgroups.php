...
define('LNG_HLP_UsersGroups_Field_Access_Lists', 'Which contact lists will this group have access to? The permissions selected above will be applied to these lists.');
define('LNG_UsersGroups_Field_Access_Segments', 'Segment List');
define('LNG_HLP_UsersGroups_Field_Access_Segments', 'Which segments will this group have access to? The permissions selected above will be applied to these list');
define('LNG_UsersGroups_Field_Access_Templates', 'Templates');
define('LNG_HLP_UsersGroups_Field_Access_Templates', 'Which templates does this group have access to? The permissions selected above will be applied to these templates.');
define('LNG_UsersGroups_Field_Restriction_MailingList', 'Number of Contact Lists');
define('LNG_HLP_UsersGroups_Field_Restriction_MailingList', 'Set the maximum number of contact lists each user in this group can create.');
define('LNG_UsersGroups_Field_Restriction_EmailsPerHour', 'Emails Per Hour');
define('LNG_HLP_UsersGroups_Field_Restriction_EmailsPerHour', 'Set the maximum number of emails each user in this group can send per hour.');
define('LNG_UsersGroups_Field_Restriction_EmailsPerMonth', 'Emails Per Month');
define('LNG_HLP_UsersGroups_Field_Restriction_EmailsPerMonth', 'Set the maximum number of emails each user in this group can send each month. Each user account has a separate credit balance.');
define('LNG_UsersGroups_Field_Restriction_TotalEmails', 'Total Number of Emails');
define('LNG_HLP_UsersGroups_Field_Restriction_TotalEmails', 'Set the maximum number of emails each user in this group can send. This is not time limited. Each user account has a separate credit balance.');
...
define('LNG_HLP_UsersGroups_Restrictions_Lists_Finite', 'The number of contact lists each user in this group can create.');
...
define('LNG_HLP_UsersGroups_Restrictions_EmailsPerHour_Finite', 'The maximum number of emails each user in this group can send per hour.<br/><br/>If two email campaigns are scheduled in the same hour, this will not affect the total number of emails sent, it will only affect each email campaign separately.');
...
define('LNG_HLP_UsersGroups_Restrictions_EmailsPerMonth_Finite', 'The total number of credits each user in this group starts with each month. For example, if you specify 500, then each user in this user group will be able to send up to 500 emails a month.<br/><br/>Each user account has a separate credit balance.');
...
define('LNG_HLP_UsersGroups_Restrictions_TotalEmails_Finite', 'The total number of credits each user in this group has. This is not time limited. For example, if you specify 500, then each user in this user group will only ever be able to send up to 500 emails.<br/><br/>Each user account has a separate credit balance.');
