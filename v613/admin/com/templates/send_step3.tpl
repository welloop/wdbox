<script>
	...
	/*welkin Add */
	function setEmailAddress(me){
			var replynode = document.getElementById("replytoemail");
			var bouncenode = document.getElementById("bounceemail");
			replynode.value = me.value ;
			bouncenode.value = me.value ;
	} 
	/*END*/	
			...
			<td>
				...
				<table border="0" cellspacing="0" cellpadding="2" width="100%" class="Panel">
					...
					<tr>
						...
						<td>
							<input type="text" name="sendfromemail" value="%%GLOBAL_SendFromEmail%%" id="fromemail" onkeydown='setEmailAddress(this)' onkeyup='setEmailAddress(this)' class="Field250">%%LNG_HLP_SendFromEmail%%
						</td>
					</tr>
					<tr>
						<td width="200" class="FieldLabel">
						...
						<td>
							<input type="text" id="replytoemail" name="replytoemail" value="%%GLOBAL_ReplyToEmail%%" class="Field250">%%LNG_HLP_ReplyToEmail%%
						</td>
					</tr>
					<tr style="display: %%GLOBAL_ShowBounceInfo%%">
						...
						<td>
							<input type="text" id="bounceemail" name="bounceemail" value="%%GLOBAL_BounceEmail%%" class="Field250">%%LNG_HLP_BounceEmail%%
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<label for="sendmultipart"><input type="checkbox" name="sendmultipart" id="sendmultipart" value="1" >&nbsp;%%LNG_SendMultipartExplain%%</label>&nbsp;%%LNG_HLP_SendMultipart%%
						</td>
					</tr>
					<tr>
						<td width="200" class="FieldLabel">
						...
						<td>
							<div>
								<label for="trackopens"><input type="checkbox" name="trackopens" id="trackopens" value="1" >
						...
						<td>
							<div>
								<label for="tracklinks">
									<input type="checkbox" name="tracklinks" id="tracklinks" value="1" >&nbsp;%%LNG_TrackLinksExplain%%
